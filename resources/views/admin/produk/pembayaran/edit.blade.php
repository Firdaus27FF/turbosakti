                            ...
                            @if ($errors->any())
                                ...
                                <form method="post" action="{{ route('pembayaran.update', $pembayaran->id ) }}">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-3" name="name" value="{{ $pembayaran->nama_order }}"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="cases">Tanggal :</label>
                                        <input type="date" class="form-control mb-3" name="price" value="{{ $pembayaran->tanggal }}"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="cases">Bayar :</label>
                                        <input type="text" class="form-control mb-3" name="price" value="{{ $pembayaran->bayar }}"/>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">

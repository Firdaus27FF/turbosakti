                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                        <form action="#">
                            ...
                            <div class="price_box">
                                    <span class="current_dark">Rp. 2000</span>                             
                            </div>
                            <div class="product_desc">
                                ...
                                <p> Keripik ini memiliki produk yang sangat berkualitas 100% halal dan bagus. Dengan rasa pedas manis dengan keripik warna kuning yang masih bagus.</p>
                            </div>
